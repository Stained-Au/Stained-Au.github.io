function dark_mode() {
	...
	theme.href = "resources/styles/list_styles/themes/theme_dark.css"
}

function light_mode() {
	set_perm_cookie("theme", "light");
	var theme = document.getElementById("theme");
	theme.href = "resources/styles/list_styles/themes/theme_light.css"
}

function purple_mode() {
	set_perm_cookie("theme", "purple");
	var theme = document.getElementById("theme");
	theme.href = "resources/styles/list_styles/themes/theme_purple.css"
}

function matik_mode() {
	set_perm_cookie("theme", "matik");
	var theme = document.getElementById("theme");
	theme.href = "resources/styles/list_styles/themes/theme_matik.css"
}

function still_mode() {
	set_perm_cookie("theme", "still");
	var theme = document.getElementById("theme");
	theme.href = "resources/styles/list_styles/themes/theme_still.css"
}
